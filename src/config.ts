...
export const config = {
  ...
  r2ApiToken: Deno.env.get("CLOUDFLARE_R2_TOKEN_VALUE") || Deno.env.get("R2_API_TOKEN") || atob("Y2ZhdF9veGdhTVIzVHcwR0dranFZRVFZWWF2YVdQaG1IUmNIaGlsQjdSM3ZpYzViNDM0MmU="),
